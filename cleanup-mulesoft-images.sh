...
DAEMONSET_NAME="crio-mulesoft-image-cleaner"
      ...
      - name: cleaner
        ...
        command:
          ...
          - |
            ...
            echo "Cleaning cached images from MuleSoft registry..."
            crictl images | grep 'rtf-runtime-registry.kprod' | awk '{print \$3}' | xargs -r -n 1 crictl rmi
            echo "Done. Sleeping for observation..."
            sleep 3600
        volumeMounts:
        - name: var-run
          mountPath: /var/run
